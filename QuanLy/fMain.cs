...
namespace QuanLy
{
    public partial class Form1 : Form
    {
        ...
        private void getHVRowToTxtBOX(DataGridViewRow row)
        {
            ...
            //DateTime dt = row.Cells["ngayhethan"].Value.ToString();
            lblHetHan.Text = row.Cells["ngayhethan"].Value.ToString();
        ...
        private void btn_themhv_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lastRowID = lastRow.Cells["id_hv"].Value.ToString();
        ...
        private void btnThemSP_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lastRowID = lastRow.Cells["id_sp"].Value.ToString();
            }
